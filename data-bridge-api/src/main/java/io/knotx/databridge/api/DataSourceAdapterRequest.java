...
public class DataSourceAdapterRequest {
   ...
   */
  public DataSourceAdapterRequest setRequest(ClientRequest request) {
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public DataSourceAdapterRequest setAdapterParams(JsonObject adapterParams) {
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public DataSourceAdapterRequest setParams(JsonObject params) {
    this.params = params;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof DataSourceAdapterRequest)) {
      return false;
    }
    DataSourceAdapterRequest that = (DataSourceAdapterRequest) o;
