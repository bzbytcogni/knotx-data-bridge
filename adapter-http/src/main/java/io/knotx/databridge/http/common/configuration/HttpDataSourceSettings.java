...
public class HttpDataSourceSettings {
   ...
   */
  public HttpDataSourceSettings(HttpDataSourceSettings other) {
   ...
   * @param json the JSON
   */
  public HttpDataSourceSettings(JsonObject json) {
    this();
    HttpDataSourceSettingsConverter.fromJson(json, this);
  ...
  public JsonObject toJson() {
    ...
    HttpDataSourceSettingsConverter.toJson(this, json);
    return json;
  }
  ...
  public HttpDataSourceSettings setPath(String path) {
    this.path = path;
    return this;
  }
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public HttpDataSourceSettings setPort(int port) {
    this.port = port;
    return this;
  }
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public HttpDataSourceSettings setAllowedRequestHeaders(Set<String> allowedRequestHeaders) {
  ...
  @GenIgnore
  public HttpDataSourceSettings setAllowedRequestHeaderPatterns(List<Pattern> allowedRequestHeaderPatterns) {
